...
export const activityMappings: ActivityMapping[] = [
  ...
  },
  {
    ...
    regions: ["prefrontal", "hippocampus", "visual"],
    description: "Math problems heavily engage the prefrontal cortex for logical reasoning, hippocampus for retrieving learned formulas, and visual cortex for processing numbers and symbols.",
  },
  {
