...
export function BrainScene({ activeRegions, onRegionClick }: BrainSceneProps) {
  const displayRegion = activeRegions.length > 0 ? activeRegions[0] : null;
      ...
      {displayRegion ? (
        <div className="relative w-full h-full flex items-center justify-center">
          <img 
            ...
            style={{
              filter: `drop-shadow(0 20px 40px ${displayRegion.color}40)`,
            }}
          />
